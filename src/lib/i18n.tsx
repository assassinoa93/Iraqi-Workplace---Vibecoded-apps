...
export const en: Dict = {
  ...
  'modal.employee.groupEligibility.note': 'Adding a group is shorthand for every current AND future station inside it — newly-added stations inherit eligibility automatically.',
...
export const ar: Dict = {
  ...
  'modal.employee.groupEligibility.note': 'اختيار مجموعة يشمل جميع محطاتها الحالية والمستقبلية — أي محطة جديدة تُضاف للمجموعة ترث الأهلية تلقائيًا.',
